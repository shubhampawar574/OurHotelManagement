        ...
        <div className="col-12 ">
          <Carousel>
            <Carousel.Item className="carousel">
              <img className="d-block w-100" src={src7} alt="First slide" />
              <Carousel.Caption>
            ...
            <Carousel.Item className="carousel">
              <img className="d-block w-100" src={src8} alt="Second slide" />
            ...
            <Carousel.Item className="carousel">
              <img className="d-block w-100" src={src9} alt="Third slide" />
              <Carousel.Caption>
            ...
            <Carousel.Item className="carousel">
              <img className="d-block w-100" src={src4} alt="Third slide" />
              <Carousel.Caption>
                {/* <h3>Third slide label</h3>
                                <p>Praesent commodo cursus magna, vel scelerisque nisl consectetur.</p> */}
              </Carousel.Caption>
